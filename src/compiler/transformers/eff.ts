...
namespace ts {
    ...
    export function transformETS(checker: TypeChecker, options: CompilerOptions, host: CompilerHost) {
        ...
        function getPathOfExtension(factory: NodeFactory, importer: EtsImporter, extension: { patched: Symbol; definition: SourceFile; exportName: string; }, source: SourceFile) {
